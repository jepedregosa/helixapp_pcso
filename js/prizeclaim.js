function prizeclaimlist(){
	$$.ajax({
		...
		success: function( response ) {
			...
			mainView.router.loadPage({url:'./modules/prizeclaim/prizeclaim.html', ignoreCache:true,
				context:{
...
function prizeclaimdetaillist(obj){
	$$.ajax({
		...
		success: function( response ) {
			$$.ajax({
				...
				success: function( response2 ) {
					mainView.router.loadPage({url:'./modules/prizeclaim/prizeclaimdetail.html', ignoreCache:true,
					context:{
						forapproval: JSON.parse(response),
...
myApp.onPageAfterAnimation('prizeclaim', function (page) {
	myApp.showIndicator();
