function paymentrequestApprovalList(){
	$$.ajax({
		...
		success: function( response ) {
			...
			mainView.router.loadPage({url:'./modules/paymentrequest/approval/paymentrequest.html', ignoreCache:true,
				context:{
...
function paymentrequestdetailApprovalList(obj){
	$$.ajax({
		...
		success: function( response ) {
			$$.ajax({
				...
				success: function( response2 ) {
					mainView.router.loadPage({url:'./modules/paymentrequest/approval/paymentrequestdetail.html', ignoreCache:true,
					context:{
						forapproval: JSON.parse(response),
...
myApp.onPageAfterAnimation('paymentrequestApp', function (page) {
	myApp.showIndicator();
